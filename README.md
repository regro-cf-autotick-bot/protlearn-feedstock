...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/protlearn-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10866&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/protlearn-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `protlearn` can be installed with:

```
conda install protlearn
```

It is possible to list all of the versions of `protlearn` available on your platform with:
